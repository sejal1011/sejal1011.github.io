...
import newImage from '../../assests/images/first.png'; // Import your image here
...
export default class DataScienceImg extends Component {
  render() {
    ...
    return (
      ...
      src={newImage} // Use your imported image here
      alt="all the data"
      width="1120"
      height="829.80067"
      style={{ objectFit: 'contain' }} // You can adjust the style as needed
      />
      );
  }
}
